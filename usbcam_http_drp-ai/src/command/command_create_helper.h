...
public:
     ...
     */
    template<class T>
    static std::string SeliarizeCommandBody(T& src)
    {
        std::stringstream ss;
        {
     ...
     */
    template<class T>
    static std::shared_ptr<T> DeseliarizeCommandBody(std::string src)
    {
        try
        {
