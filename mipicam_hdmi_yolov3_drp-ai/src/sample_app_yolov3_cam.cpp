...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : sample_app_yolov3_cam.cpp
* Version      : 7.30
...
int8_t print_result(Image* img)
{
    ...
    for (i = 0; i < det.size(); i++)
    {
        ...
        str = stream.str();
        img->write_string_rgb(str, DRPAI_IN_WIDTH * RESIZE_SCALE + TEXT_WIDTH_OFFSET, LINE_HEIGHT+LINE_HEIGHT_OFFSET+result_cnt*LINE_HEIGHT, CHAR_SCALE_SMALL, WHITE_DATA);
    }
    ...
    if (ai_inf_prev != (uint32_t) ai_time)
    {
        ...
        stream.str("");
        stream << "DRP-AI Time: " << ai_inf_prev << "msec";
        str = stream.str();
    }
